      ...
      repository === ''
        ...
        : (
            <button className="btn-repo group relative p-0.5 desktop:p-1 phone:text-xs tablet:text-sm desktop:text-base phone:rounded-lg desktop:rounded-xl hover:shadow-lg transition-all duration-500 overflow-hidden">
              ...
              <a href={repository} target='_blank' rel='noreferrer' className="relative flex items-center justify-center text-white group-hover:text-black bg-gray-800 group-hover:bg-gray-50 phone:py-1 phone:px-2 desktop:py-2 desktop:px-4 phone:rounded-md desktop:rounded-lg shadow-md group-hover:shadow-none">
              <img className="phone:max-h-4 tablet:max-h-5 tablet:mr-2 phone:mr-1 pl-1" src={`${import.meta.env.BASE_URL}images/code-icon.svg`} alt="Repo"/>
              <p>Repository</p>
              </a>
            </button>
      ...
      preview === ''
        ...
        : (
            <button className="btn-repo group relative p-0.5 desktop:p-1 phone:text-xs tablet:text-sm desktop:text-base phone:rounded-lg desktop:rounded-xl hover:shadow-lg transition-all duration-500 overflow-hidden">
              ...
              <a href={preview} target='_blank' rel='noreferrer' className="relative flex items-center justify-center text-white group-hover:text-blue-900 bg-blue-800 group-hover:bg-blue-50 phone:py-1 phone:px-2 desktop:py-2 desktop:px-4 phone:rounded-md desktop:rounded-lg shadow-md group-hover:shadow-none">
      ...
      download === ''
        ...
        : (
            <button className="btn-repo group relative p-0.5 desktop:p-1 phone:text-xs tablet:text-sm desktop:text-base phone:rounded-lg desktop:rounded-xl hover:shadow-lg transition-all duration-500 overflow-hidden">
              ...
              <a href={download} target='_blank' rel='noreferrer' className="relative flex items-center justify-center text-white group-hover:text-amber-900 bg-amber-800 group-hover:bg-amber-50 phone:py-1 phone:px-2 desktop:py-2 desktop:px-4 phone:rounded-md desktop:rounded-lg shadow-md group-hover:shadow-none">
